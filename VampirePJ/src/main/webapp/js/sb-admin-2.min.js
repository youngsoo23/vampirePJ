...
!function(t) {
	"use strict";
	t("#sidebarToggle, #sidebarToggleTop").on(
			"click",
			function(o) {
				t("body").toggleClass("sidebar-toggled"), t(".sidebar")
						.toggleClass("toggled"), t(".sidebar").hasClass(
						"toggled")
		...
		t(window).width() < 768 && t(".sidebar .collapse").collapse("hide")
			...
			"scroll",
			function() {
				100 < t(this).scrollTop() ? t(".scroll-to-top").fadeIn() : t(
